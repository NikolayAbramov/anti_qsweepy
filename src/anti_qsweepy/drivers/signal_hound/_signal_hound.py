...
get_serial_number_list = get_serial_number_list_proto(("saGetSerialNumberList", signal_hound_dll),
                                                      ((2, 'serial_numbers'), (2, 'device_count')))
...
open_device_by_serial_number = open_device_by_serial_number_proto(("saOpenDeviceBySerialNumber", signal_hound_dll),
                                                                  ((2, 'device'), (1, 'serial_number')))
...
get_firmware_string = get_firmware_string_proto(("saGetFirmwareString", signal_hound_dll),
                                                ((1, 'device'), (2, 'firmware_string')))
...
config_acquisition = config_acquisition_proto(("saConfigAcquisition", signal_hound_dll),
                                              ((1, 'device'), (1, 'detector'), (1, 'scale')))
...
config_center_span = config_center_span_proto(("saConfigCenterSpan", signal_hound_dll),
                                              ((1, 'device'), (1, 'center'), (1, 'span')))
...
config_gain_atten = config_gain_atten_proto(("saConfigGainAtten", signal_hound_dll),
                                            ((1, 'device'), (1, 'atten'), (1, 'gain'), (1, 'preamp')))
# SA_API saStatus saConfigGainAtten(int device, int atten, int gain, bool preAmp);

config_sweep_coupling_proto = ctypes.WINFUNCTYPE(ctypes.c_int, ctypes.c_int, ctypes.c_double, ctypes.c_double,
                                                 ctypes.c_bool)
config_sweep_coupling = config_sweep_coupling_proto(("saConfigSweepCoupling", signal_hound_dll),
                                                    ((1, 'device'), (1, 'rbw'), (1, 'vbw'), (1, 'reject')))
...
config_audio = config_audio_proto(("saConfigAudio", signal_hound_dll),
                                  ((1, 'device'), (1, 'audioType'), (1, 'center_freq'), \
...
config_real_time = config_real_time_proto(("saConfigRealTime", signal_hound_dll),
                                          ((1, 'device'), (1, 'frame_scale'), (1, 'frame_rate')))
...
config_real_time_overlap = config_real_time_overlap_proto(("saConfigRealTimeOverlap", signal_hound_dll),
                                                          ((1, 'device'), (1, 'advance_rate')))
...
query_real_time_frame_info_proto = ctypes.WINFUNCTYPE(ctypes.c_int, ctypes.c_int, ctypes.POINTER(ctypes.c_int),
...
get_sweep_32f_proto = ctypes.WINFUNCTYPE(ctypes.c_int, ctypes.c_int, ctypes.POINTER(ctypes.c_float),
...
get_sweep_64f_proto = ctypes.WINFUNCTYPE(ctypes.c_int, ctypes.c_int, ctypes.POINTER(ctypes.c_double),
...
get_partial_sweep_32f_proto = ctypes.WINFUNCTYPE(ctypes.c_int, ctypes.c_int, ctypes.POINTER(ctypes.c_float),
                                                 ctypes.POINTER(ctypes.c_float), \
...
get_partial_sweep_64f_proto = ctypes.WINFUNCTYPE(ctypes.c_int, ctypes.c_int, ctypes.POINTER(ctypes.c_double),
                                                 ctypes.POINTER(ctypes.c_double), \
                                                 ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_int))
...
get_real_time_frame_proto = ctypes.WINFUNCTYPE(ctypes.c_int, ctypes.c_int, ctypes.POINTER(ctypes.c_float),
                                               ctypes.POINTER(ctypes.c_float))
get_real_time_frame = get_real_time_frame_proto(("saGetRealTimeFrame", signal_hound_dll),
                                                ((1, 'device'), (1, 'sweep'), (1, 'frame')))
...
get_iq_data_unpacked_proto = ctypes.WINFUNCTYPE(ctypes.c_int, ctypes.c_int, ctypes.POINTER(ctypes.c_float),
                                                ctypes.c_int, ctypes.c_int, \
                                                ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_int), \
                                                ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_int))
get_iq_data_unpacked = get_iq_data_unpacked_proto(("saGetIQDataUnpacked", signal_hound_dll),
                                                  ((1, 'device'), (1, 'iq_data'), (1, 'iq_count'), \
                                                   (1, 'purge'), (2, 'data_remaining'), (2, 'sample_loss'), (2, 'sec'),
                                                   (2, 'milli')))
...
get_tg_freq_ampl_proto = ctypes.WINFUNCTYPE(ctypes.c_int, ctypes.c_int, ctypes.POINTER(ctypes.c_double),
                                            ctypes.POINTER(ctypes.c_double))
get_tg_freq_ampl = get_tg_freq_ampl_proto(("saGetTgFreqAmpl", signal_hound_dll),
                                          ((1, 'device'), (2, 'frequency'), (2, 'amplitude')))
# SA_API saStatus saGetTgFreqAmpl(int device, double *frequency, double *amplitude);

config_if_output_proto = ctypes.WINFUNCTYPE(ctypes.c_int, ctypes.c_int, ctypes.c_double, ctypes.c_double, ctypes.c_int,
                                            ctypes.c_int)
config_if_output = config_if_output_proto(("saConfigIFOutput", signal_hound_dll),
                                          ((1, 'device'), (1, 'input_freq'), (1, 'output_freq'), \
...
get_error_string = ctypes.WINFUNCTYPE(ctypes.c_char_p, ctypes.c_int)(("saGetErrorString", signal_hound_dll),
                                                                     ((1, 'code'),))
